...
async def serve_dashboard():
    ...
    import pathlib
    dashboard_path = pathlib.Path(__file__).parent.parent / "dashboard.html"
...
async def get_platforms():
    """Get list of supported platforms - Only Xiaohongshu supported"""
    return {
        "platforms": [
            {"value": "xhs", "label": "小红书 (Xiaohongshu)", "icon": "book-open"},
        ]
    }
...
async def get_config_options():
    ...
    return {
        ...
        "sort_types": [
            {"value": "popularity_descending", "label": "点赞数排序"},
            {"value": "comment_descending", "label": "评论数排序"},
            {"value": "time_descending", "label": "时间维度排序"},
        ],
    }
